...
<?php
		...
		while(($line = fgets($handle))!==false)
		{
			...
			$str = explode(",", $line);
				if(count($str)==7)
				{
				mysql_query("INSERT INTO ".$_POST['section']." (qs,op1,op2,op3,op4,ans,mode) VALUES ('$str[0]','$str[1]','$str[2]','$str[3]','$str[4]','$str[5]','$str[6]')") or die(mysql_error());
      									...
      									<form class="well span6" action="admin.php" method="post" enctype="multipart/form-data">
      										<div class="form-group">
         										...
         										<div class="input-group">
          											...
          											<select class="form-control" name="section" placeholder="Section"><option value="verbal">Verbal</option><option value="quants">Quants</option><option value="logical">Logical</option><option value="techcial">Technical</option></select>
