...
<div class="row">
<div class="span12">
	<a href="index.html" class="banner"><h1><?php echo $mydata['projectName']; ?></h1></a>

<div class="pull-right"> <br/>
	<a href="product_summary.html"> <span class="btn btn-mini btn-warning" id="no_of_cart"> <i id="no_of_cart" class="icon-shopping-cart icon-white"></i> </span> </a>
