...
if(isset($_GET['pid']))
{
	...
	$output = array('pid'=>$row['pid'],'pname'=>$row['product_name'],'price'=>$row['price'],'availablity'=>$row['availability'],'imgurl'=>"/assets/products/".$row['pid'].".jpg",'productUrl'=>'product_details.php?pid='.$row['pid'],'description'=>$row['description'],'keyowords'=>$row['keywords']);
