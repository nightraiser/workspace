...
$b=$_SESSION['branch'];
$y=$_SESSION['year'];
$q=mysql_query("SELECT * FROM dbs ORDER BY dbname DESC") or die("query problem");
$output='';
$search=$_POST['search'];
...
<div class='info'>
<b align='center'>Add</b><hr>
<ul class='stats'>
											
											<li><a href='addtofav.php?dbid=$res[dbid]' class='fa fa-heart'></a></li>
											
										</ul>
</div>

<div class='thumb'><h1><a href='article.php?dbid=$res[dbid]'>$res[dbname]</a></h1></div>
						...
						<!-- Nav -->
							...
							<nav id="nav">
								<ul>
									...
									<li><a href="mydash.php">My Boards</a></li>	
									<?php
...
<li><a href='feedback.php'>Feed Back</a></li>
									...
									<li><form action="dash.php" method="post" align="center">
